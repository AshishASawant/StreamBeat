...
const Search = () => {
  ...
  const demosSong = [
      ...
      },
      {
        album: {
          ...
          artists: [
            {
              external_urls: {
                spotify:
                  "https://open.spotify.com/artist/5uemEEtB1ZC3s1KM7gReeH",
              },
          ...
          external_urls: {
            spotify: "https://open.spotify.com/album/5Xrj5h7GQkxcjXRWJAtNvF",
          },
          href: "https://api.spotify.com/v1/albums/5Xrj5h7GQkxcjXRWJAtNvF",
          id: "5Xrj5h7GQkxcjXRWJAtNvF",
          images: [
            {
              height: 640,
              url: "https://i.scdn.co/image/ab67616d0000b273a1cb9c60bf2838497ef6d726",
              width: 640,
            },
            {
              height: 300,
              url: "https://i.scdn.co/image/ab67616d00001e02a1cb9c60bf2838497ef6d726",
              width: 300,
            },
            {
              height: 64,
              url: "https://i.scdn.co/image/ab67616d00004851a1cb9c60bf2838497ef6d726",
              width: 64,
            },
          ],
          name: "Insaan",
          ...
          total_tracks: 11,
          type: "album",
          uri: "spotify:album:5Xrj5h7GQkxcjXRWJAtNvF",
        },
        artists: [
          {
            external_urls: {
        ...
        duration_ms: 195428,
        explicit: true,
        external_ids: { isrc: "FR10S2255389" },
        external_urls: {
          spotify: "https://open.spotify.com/track/3k9PtGmPNnQtt32TKWm6f3",
        },
        href: "https://api.spotify.com/v1/tracks/3k9PtGmPNnQtt32TKWm6f3",
        id: "3k9PtGmPNnQtt32TKWm6f3",
        is_local: false,
        name: "Basti Ka Hasti",
        popularity: 73,
        preview_url:
          "https://p.scdn.co/mp3-preview/6b07c194b273806be93fbc83340c5ddd0530a9a3?cid=b8aca1007f284e1d80bf93f9f0c6d0a1",
        track_number: 6,
        type: "track",
        uri: "spotify:track:3k9PtGmPNnQtt32TKWm6f3",
      },
      {
        album: {
          album_group: "album",
  ...
  return (
    <div className="w-full  md:py-0 overflow-y-scroll hide-scroll md:px-0 relative">
      <div className="flex items-center justify-center  pb-3 sticky  top-0 left-0 z-10 w-screen md:w-full bg-bg-main px-2">
        <input
          type="text"
          placeholder="Search"
