...
const Toggle = ({method,state}) => {
  return (
    <div className='flex h-min  bg-black rounded-full px-1 py-1 relative'>
        <span className='z-10 md:w-20 w-14  md:text-base text-center text-sm cursor-pointer' onClick={()=>method('movie')}>Movie</span>
        <span className='z-10 md:w-20 w-14  md:text-base text-center text-sm cursor-pointer' onClick={()=>method('music')}>Music</span>
